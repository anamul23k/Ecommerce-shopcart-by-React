    ...
    >
      <div className={`footer`}>
        <div className="footer__links">
          <a
            href="https://github.com/anamul23k"
            target="_blank"
            rel="noreferrer"
          >
            {" "}
          ...
          <a
            href="https://www.linkedin.com/in/md-anamul-hoque-833857198/"
            target="_blank"
            rel="noreferrer"
          >
            <BsLinkedin
        ...
        <div className="footer__links-alt">
          ...
          >
            © 2024 Md Anamul Hoque. All rights Reserved.
          </p>
          |
          <a
            target="_blank"
